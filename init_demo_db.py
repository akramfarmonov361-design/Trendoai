...
logger = setup_logger("init_demo_db")
...
def init_demo_db():
    with app.app_context():
        ...
        if MenuCategory.query.count() == 0:
            logger.info("Demo kategoriyalar qo'shilmoqda...")
            ...
            logger.info("Demo xizmatlar qo'shilmoqda...")
            ...
            db.session.commit()
            logger.info("To'liq muvaffaqiyatli yakunlandi!")
        else:
            logger.info("Bazaga allaqachon ma'lumot kiritilgan.")
