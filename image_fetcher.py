...
def get_image_for_topic(topic, width=1200, height=630, exclude_image_urls=None):
    ...
    topic_keywords = {
        "sun'iy intellekt": "artificial intelligence neural network",
        "ai": "artificial intelligence technology",
        "dasturlash": "software programming code",
        "python": "python code programming",
        "texnologiya": "modern technology digital",
        "telegram": "telegram mobile app smartphone",
        "bot": "automation chatbot robot interface",
        "web": "web development responsive design",
        "sayt": "website design coding",
        "landing": "landing page web design",
        "mobile": "mobile app smartphone",
        "kiberxavfsizlik": "cybersecurity data protection",
        "startap": "startup business team meeting",
        "biznes": "business growth finance office",
        "marketing": "digital marketing social media strategy",
        "smm": "social media marketing smartphone",
        "target": "digital advertising analytics audience",
        "crm": "crm dashboard analytics data",
        "e-commerce": "online store shopping cart",
        "do'kon": "ecommerce retail store technology",
        "to'lov": "mobile payment fintech online checkout",
        "robot": "robotics automation industry",
        "cloud": "cloud computing server network",
        "data": "data science analytics visualization",
        "blockchain": "blockchain crypto digital currency",
